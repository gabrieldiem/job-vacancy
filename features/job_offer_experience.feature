...
Feature: Add experience required to job offer
  ...
  Background:
  As a job offerer
  I want to add required Experience required to the job offer
  So that candidates can see the experience needed for the job

  Scenario: US-3.1 Successful job offer creation with experience required
    When I create a job offer with "2" years of required experience
    Then I should see "2 years" required experience in the job offers list
    And I should see it in my offers as well
  ...
  Scenario: US-3.3 Job offer with 0 years of required experience shows no required experience
    When I create a job offer with "0" years of required experience
